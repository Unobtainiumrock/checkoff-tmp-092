...
public class Graph implements Iterable<Integer> {
    ...
    public List<Integer> path(int start, int stop) {
        ...
        for (int i = 0; i < dfsList.size(); i++) { //[1, 2, 3, 4, 5] start = 1, stop = 3
            res.add(dfsList.get(i)); //res = [1, 2, 3]
            if (dfsList.get(i) == stop) {
                return res;
            }
        }
//        res.add(start);
...
//            boolean f = this.from == a.from;
//            boolean t = this.to == a.to;
//            boolean w = this.weight == a.weight;
//            return f && t && w;
//        }
...
//        LinkedList<Edge> test = new LinkedList<>();
//        test.add(new Edge(1, 2, 0));
//        System.out.println(test.indexOf(new Edge(1, 2, 0)));
